...
#include <utils/debug.h>
    ...
    #endif
#elif defined(WIN32)
    #if defined(FILAMENT_SUPPORTS_OPENGL) && !defined(FILAMENT_USE_EXTERNAL_GLES3) && !defined(FILAMENT_USE_ANGLE)
...
Platform* PlatformFactory::create(Backend* backend, void* nativeDisplay) noexcept {
    SYSTRACE_CALL();
