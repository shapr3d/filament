...
MetalBufferObject::MetalBufferObject(MetalContext& context, uint32_t byteCount, bool wrapsNativeBuffer)
        : HwBufferObject(byteCount), buffer(std::make_unique<MetalBuffer>(context, byteCount, wrapsNativeBuffer)) {}
