...
TEST(HandlesTest, useAfterFreePool) {
    // Shapr: pool ratios equal to the pool sizes give the same number of handles per pool
    HandleAllocatorTest allocator("Test Handles", POOL_SIZE_BYTES, {32, 96, 136}, false);
