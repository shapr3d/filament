...
void FIndirectLight::setIblCenter(const float3& iblCenter) noexcept {
    mIblOptions.iblCenter = iblCenter;
}

const float3& FIndirectLight::getIblCenter() const noexcept {
    return mIblOptions.iblCenter;
}

void FIndirectLight::setIblHalfExtents(const float3& iblHalfExtents) noexcept {
    mIblOptions.iblHalfExtents = iblHalfExtents;
}

const float3& FIndirectLight::getIblHalfExtents() const noexcept {
    return mIblOptions.iblHalfExtents;
}

void FIndirectLight::setIblTintAndIntensity(const float4& iblTintAndIntensity) noexcept {
    mIblOptions.iblTintAndIntensity = iblTintAndIntensity;
}

const float4& FIndirectLight::getIblTintAndIntensity() const noexcept {
