        ...
        if (rinstance) {
            ...
            if (entityMaterial != mTweakedMaterials.end()) {
                ...
                for (size_t prim = 0; prim < numPrims; ++prim) {
                    ...
                    matInstance->setParameter("textureScaler", math::float4(tweaks.mBaseTextureScale * 0.1, tweaks.mNormalTextureScale * 0.1, tweaks.mClearCoatTextureScale * 0.1, tweaks.mRefractiveTextureScale * 0.1));
